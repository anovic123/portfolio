          ...
          <Container>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="ms-auto">
                ...
                <Nav.Link href="#skills" className={activeLink === 'skills' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('skills')}>Навычки</Nav.Link>
              ...
              <span className="navbar-text">
                <div className="social-icon">
                  <a href="https://t.me/+380992547798"><img src={navIcon1} alt="" /></a>
                  <a href="mailto:anovicjosip@gmail.com"><img src={navIcon2} alt="" /></a>
